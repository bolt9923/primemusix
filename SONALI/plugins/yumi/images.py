...
@app.on_message(filters.command(["ijawjamjajgahshdddddddddddddddd333333___%%", "ajjaahaaahahashahahaahhashaa#@@##$$##$43"], prefixes=["/", "!"]))
async def google_img_search(client: Client, message: Message):
    ...
    msg = await message.reply("❍ sɪʟʟʏ ᴍᴜsɪᴄ ғɪɴᴅɪɴɢ ɪᴍᴀɢᴇs.....")
